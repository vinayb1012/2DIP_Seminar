...
\begin{document}
	...
	Table \ref{datasets} shows various image-based and video datasets. Most methods use the 300-VW(300 Videos in the Wild)\cite{300-VW} and the TF(Talking Faces)\cite{tf} datasets to evaluate their models and compete in the 300-VW challenge.
