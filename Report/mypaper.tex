...
AFLW             & Annotated Facial Landmarks in the Wild & \begin{tabular}[c]{@{}l@{}}Around 25k annotated face \\images with 21  landmarks per image\end{tabular}                                           & Yes            \\ \hline
LFW              & Labeled Faces in the Wild              & \begin{tabular}[c]{@{}l@{}}13,233 images of 5749 people detected \\ and centered by Viola Jones face detector\end{tabular}                        & Yes            \\ \hline
Helen            & Helen facial feature dataset           & \begin{tabular}[c]{@{}l@{}}2000 training and 330 test images with \\194 landmarks and accurate \\ annotations of primary facial components\end{tabular} & Yes             \\ \hline
LFPW             & Labeled Face Parts in the Wild         & \begin{tabular}[c]{@{}l@{}}1432 images with 29 landmarks on each \\ image\end{tabular}                                                            & Yes            \\ \hline
TF               & Talking Face                           & \begin{tabular}[c]{@{}l@{}}5000 frames of a person engaged in a\\ conversation with 68 landmarks in each \\frame on each image\end{tabular}                                                 & No             \\ \hline
FM               & Face Movies                            & \begin{tabular}[c]{@{}l@{}}2150 images of 6 videos with 68 \\landmarks on each image\end{tabular}                                                & Yes            \\ \hline
...
BIWI             & Biwi kinect head pose database         & \begin{tabular}[c]{@{}l@{}}24 videos with over 15k frames of 20\\ people                                                                                                                   \end{tabular}   & Yes            \\ \hline
COFW             & Caltech Occluded Faces in the Wild     & \begin{tabular}[c]{@{}l@{}}1007 occluded face images with 29 \\manually annotated landmarks\end{tabular}                                         & Yes            \\ \hline
IBUG             & IBUG dataset     & \begin{tabular}[c]{@{}l@{}}135 images with difficult poses and \\expressions\end{tabular}                                         & Yes            \\ \hline
